            ...
            <div className="container relative mx-auto px-4 md:px-6 z-10">
                <div className="max-w-xl mx-auto">
                    <motion.div
                        ...
                        className="glass dark:glass-dark rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 shadow-2xl shadow-blue-500/5 overflow-hidden"
                    >
                        <div className="bg-zinc-900 border-b border-white/5 p-10 text-center relative overflow-hidden group">
                            ...
                            <Shield className="w-16 h-16 text-blue-400 mx-auto mb-6 relative" />
                        ...
                        <div className="p-10">
                            {submitted ? (
                                ...
                                >
                                    <div className="w-16 h-16 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 mx-auto mb-6 shadow-inner">
                                    ...
                                    <Link to="/" className="inline-flex items-center text-xs font-black uppercase tracking-widest text-blue-600 dark:text-blue-400 hover:gap-2 transition-all">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            id="email"
                                            required
                                            className="w-full px-6 py-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all font-bold"
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full py-5 px-6 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-black text-xs uppercase tracking-widest rounded-2xl transition-all hover:bg-blue-600 dark:hover:bg-blue-400 dark:hover:text-white shadow-xl hover:shadow-blue-600/20 active:scale-95"
                                    >
                                        Inquire Securely
                                    </button>
