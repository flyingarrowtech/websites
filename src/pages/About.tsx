        ...
        <div ref={containerRef} className="overflow-hidden bg-white dark:bg-zinc-950 transition-colors duration-500">
            ...
            <section className="relative pt-40 pb-24 overflow-hidden bg-zinc-50 dark:bg-zinc-950/50">
                <div className="absolute inset-0 pointer-events-none">
                    ...
                    <div className="absolute bottom-0 left-0 w-[40%] h-[40%] bg-green-500/10 blur-[100px] rounded-full" />
                </div>
                ...
                <div className="container relative mx-auto px-4 md:px-6 text-center z-10">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 py-1 px-3 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs font-black uppercase tracking-widest mb-6"
                    >
                        Our Mission
                    </motion.div>
                    <h1 className="text-5xl md:text-7xl font-black text-zinc-900 dark:text-white mb-8 tracking-tight">
                        We build <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-cyan-400 to-green-500">better</span>.
                    </h1>
                    ...
                    <div className="story-section flex flex-col lg:flex-row gap-16 items-center">
                        <div className="story-content flex-1 max-w-2xl">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12">
                                ...
                                <div className="p-6 rounded-2xl glass dark:glass-dark border border-zinc-100 dark:border-zinc-800">
                                    <div className="w-10 h-10 rounded-xl bg-green-600 flex items-center justify-center text-white mb-4">
                        ...
                        <div className="story-image flex-1 relative group">
                            <div className="absolute inset-0 bg-blue-600/20 rounded-3xl -rotate-3 scale-105 transition-transform group-hover:rotate-0" />
                            <img
                                src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop"
                                alt="Our Team"
                                className="relative rounded-3xl shadow-2xl w-full object-cover aspect-[4/3]"
                            />
                            <div className="absolute -bottom-6 -right-6 p-6 glass dark:glass-dark rounded-2xl shadow-xl hidden md:block border border-blue-100 dark:border-blue-900">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 via-cyan-400 to-green-500 flex items-center justify-center text-white">
                ...
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[
                            ...
                            <div key={`${member.name}-${index}`} className="team-card group p-8 rounded-3xl glass dark:glass-dark text-center transition-all hover:-translate-y-2 duration-500 border border-zinc-100 dark:border-zinc-800 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/10">
                                <div className="relative w-32 h-32 mx-auto mb-8">
                                    <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-cyan-400 to-green-500 rounded-full animate-pulse-glow opacity-50 group-hover:scale-110 transition-transform" />
                                    <div className="relative w-full h-full rounded-full bg-zinc-900 flex items-center justify-center text-white ring-4 ring-white dark:ring-zinc-800 group-hover:ring-blue-500 transition-all">
                                        <span className="text-3xl font-black tracking-tighter">{member.initials}</span>
                                    </div>
                                    <div className="absolute -bottom-2 -right-2 bg-blue-600 text-white text-[8px] font-bold px-2 py-1 rounded-full uppercase tracking-widest shadow-lg">
                                        {member.label}
                                    </div>
                                </div>

                                <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">{member.name}</h3>
                                <p className="text-blue-600 dark:text-blue-400 mb-6 font-bold text-sm uppercase tracking-wide">{member.role}</p>
